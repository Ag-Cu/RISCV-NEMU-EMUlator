...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 000 ????? 01110 11", addw   , R, Reg(dest) = src1 + src2);
  INSTPAT("0100000 ????? ????? 000 ????? 01110 11", subw   , R, Reg(dest) = src1 - src2);
  ...
  INSTPAT("??????? ????? ????? 000 ????? 00110 11", addiw  , I, Reg(dest) = src1 + imm); 
